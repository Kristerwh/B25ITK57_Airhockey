...
from environment.env_settings.environments import iiwas as iiwas
from environment.env_settings.environments import planar as planar
from environment.env_settings.utils import inverse_kinematics


class PositionControl:
    def __init__(self, p_gain, d_gain, i_gain,env_info=None, interpolation_order=3, debug=False, *args, **kwargs):
        """
        ...
        self.n_agents = self.env_info.get("n_agents", 1)
        self.actuator_joint_ids = self.env_info.get("actuator_joint_ids", [6, 7, 8, 9, 10, 11, 12])  # Default IDs
        self._timestep = self.env_info.get("_timestep", 0.02)
