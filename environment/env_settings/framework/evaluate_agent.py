...
from environment.env_settings.framework.air_hockey_challenge_wrapper import AirHockeyChallengeWrapper
from environment.env_settings.framework.challenge_core import ChallengeCore
...
def evaluate(agent_builder, log_dir, env_list, n_episodes=1080, n_cores=-1, seed=None, generate_score=None,
    ...
    replay_dataset function in env_settings/utils/replay_dataset.py. This function is intended to be called
    by run.py.
