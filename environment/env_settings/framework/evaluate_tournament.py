...
from environment.env_settings.framework import AirHockeyChallengeWrapper, ChallengeCore
from environment.env_settings.utils.tournament_agent_wrapper import SimpleTournamentAgentWrapper, \
...
def run_tournament(build_agent_1, log_dir, build_agent_2=None, agent_2_kwargs={}, steps_per_game=45000, n_episodes=1,
    ...
    the replay_dataset function in env_settings/utils/replay_dataset.py. This function is intended to be called
    by run.py.
