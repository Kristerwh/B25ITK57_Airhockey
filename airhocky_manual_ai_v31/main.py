...
TABLE_WIDTH = 2128
TABLE_HEIGHT = 1218
TABLE_WIDTH_RIM_OFFSET = 45
TABLE_HEIGHT_RIM_OFFSET = 45
MALLET_POS = 50 + TABLE_WIDTH_RIM_OFFSET,(TABLE_HEIGHT / 2) + TABLE_HEIGHT_RIM_OFFSET
DEFENSE_BOX_X = (TABLE_WIDTH/3) + TABLE_WIDTH_RIM_OFFSET
DEFENSE_BOX_Y = (TABLE_HEIGHT/6) + TABLE_HEIGHT_RIM_OFFSET , ((5 * TABLE_HEIGHT) / 6) + TABLE_HEIGHT_RIM_OFFSET
